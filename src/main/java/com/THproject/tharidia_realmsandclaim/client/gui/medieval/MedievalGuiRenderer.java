package com.THproject.tharidia_realmsandclaim.client.gui.medieval;
...
public class MedievalGuiRenderer {
    ...
    public static final int DARK_PURPLE = PURPLE_DARK;         // Alias for compatibility
    ...
    public static final int SHADOW = SHADOW_MEDIUM;            // Alias for compatibility
