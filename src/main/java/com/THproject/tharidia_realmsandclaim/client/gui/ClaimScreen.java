...
import com.THproject.tharidia_realmsandclaim.client.gui.components.PlayerInventoryPanelRenderer;
...
public class ClaimScreen extends AbstractContainerScreen<ClaimMenu> {
    ...
    public ClaimScreen(ClaimMenu menu, Inventory playerInventory, Component title) {
        super(menu, playerInventory, Component.translatable("gui.tharidia_realmsandclaim.claim.parchment_title"));
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        MedievalGuiRenderer.renderMedievalTitle(guiGraphics, Component.translatable("gui.tharidia_realmsandclaim.claim.title").getString(),
    ...
    private void renderClaimInfo(GuiGraphics gui, int x, int y) {
        ...
        renderMedievalTextLine(gui, Component.translatable("gui.tharidia_realmsandclaim.claim.owner_label").getString(), textX, yPos, MedievalGuiRenderer.BROWN_INK);
        yPos += 16;
        ...
        renderMedievalTextLine(gui, Component.translatable("gui.tharidia_realmsandclaim.claim.status_label").getString(), textX, yPos, MedievalGuiRenderer.BROWN_INK);
        yPos += 16;
        ...
        if (isRented && expirationTime > 0) {
            ...
            if (timeLeft <= 0) {
                renderMedievalTextLine(gui, Component.translatable("gui.tharidia_realmsandclaim.claim.expired").getString(), textX + 20, yPos, MedievalGuiRenderer.DEEP_CRIMSON);
            } else {
                ...
                renderMedievalTextLine(gui, Component.translatable("gui.tharidia_realmsandclaim.claim.time_left_label").getString(), textX + 20, yPos, MedievalGuiRenderer.BROWN_INK);
                yPos += 16;

                String timeText = Component.translatable("gui.tharidia_realmsandclaim.claim.time_left_value", hours, minutes, seconds).getString();
                ...
                renderMedievalTextLine(gui, Component.translatable("gui.tharidia_realmsandclaim.claim.expires_on_label").getString(), textX + 20, yPos, MedievalGuiRenderer.BROWN_INK);
                yPos += 16;
                renderMedievalTextLine(gui, "§f" + expiresDate, textX + 40, yPos, MedievalGuiRenderer.BLACK_INK);
            }
        } else {
            renderMedievalTextLine(gui, Component.translatable("gui.tharidia_realmsandclaim.claim.perpetual").getString(), textX + 20, yPos, MedievalGuiRenderer.PURPLE_REGAL);
        }
        ...
        renderMedievalTextLine(gui, Component.translatable("gui.tharidia_realmsandclaim.claim.protection_radius_label").getString(), textX, yPos, MedievalGuiRenderer.BROWN_INK);
        yPos += 16;
        renderMedievalTextLine(gui, Component.translatable("gui.tharidia_realmsandclaim.claim.protection_radius_value", protectionRadius).getString(), textX + 20, yPos, MedievalGuiRenderer.ROYAL_GOLD);
    }
